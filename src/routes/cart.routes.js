...
router.post('/cart/user/:iduser/product/:idproducto', validateParamsSchema(addToCarritoSchema), addProductToCart);

//Eliminar un producto del carrito del usuario
router.delete('/cart/user/:iduser/product/:idproducto', validateParamsSchema(deleteFromCarritoSchema), deleteProductFromCart);
